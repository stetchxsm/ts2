...
const ServicesSection = () => {
  ...
  const getFeatures = (key: string): string[] => {
    try {
      ...
      console.warn(`Failed to load features for ${key}:`, error);
      return [];
    }
  };
  ...
  const services = [
    {
      ...
      features: getFeatures('services.travel.features'),
    ...
    },
    {
      ...
      features: getFeatures('services.education.features'),
    ...
    },
    {
      ...
      features: getFeatures('services.trade.features'),
